...
public class UserKNNRecall implements Recall {
    public UserKNNRecall() throws IOException, LibrecException {
    ...
    public static void main(String[] args) throws IOException, LibrecException, SQLException {
        UserKNNRecall tp = new UserKNNRecall();
        tp.run();
    }
}
