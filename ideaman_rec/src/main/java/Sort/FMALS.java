...
public class FMALS implements Sort {
    public FMALS() throws IOException, LibrecException {
    ...
    public static void saveResult(List<RecommendedItem> recommendedList) throws LibrecException, IOException, ClassNotFoundException, TException {
        ...
        if (recommendedList != null && recommendedList.size() > 0) {
            ...
            for (String uid : uid2items.keySet()) {
                ...
                String sql = String.format("UPDATE user_rec SET als_recall = \"%s\" WHERE user_id = %s;\n", item_ids, uid);
    ...
    public void run() throws LibrecException, IOException {
        ...
        Recommender recommender = new AssociationRuleRecommender();
