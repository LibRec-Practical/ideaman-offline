...
class Summarizer:
    ...
    def summarize(self, text, title, source, category):
        ...
        titleWords = self.parser.splitWords(titleWords) # modified
    ...
    def computeScore(self, sentences, titleWords, topKeywords):
        ...
        for i, sentence in enumerate(sentences):
            ...
            totalScore = (titleFeature * 1.5 + keywordFrequency * 2.0 + sentenceLength * 0.5 + sentencePosition * 1.0) / 5.0 # modified
